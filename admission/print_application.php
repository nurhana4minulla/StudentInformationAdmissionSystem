...
elseif (isset($_SESSION['last_student_id']) && !empty($_SESSION['last_student_id'])) {
    $student_id = $_SESSION['last_student_id'];
} 

else {
    die("Error: No application ID found. Please go back to the confirmation page and click the print link.");
}
...
// helper function to check a radio/checkbox
...
<head>
    ...
    <title>WMSU Admission Form - <?php echo e($student['last_name']); ?></title>
    <style>
        body {
        ...
        .edu-grid {
            display: grid;
            grid-template-columns: 0.8fr 2fr 2fr 1fr;
            gap: 8px 15px;
...
<body>
    ...
    <div class="no-print" style="text-align: center; padding: 20px;">
        <button onclick="window.print()" style="padding: 15px 30px; font-size: 1.2em; cursor: pointer; background-color: #0056b3; color: white; border: none; border-radius: 5px;">
        ...
        <form id="admissionForm">
            ...
            <div class="header-right" style="padding: 0; overflow: hidden; display: flex; justify-content: center; align-items: center;">
                        ...
                        if (!empty($student['photo_path'])) {
                            ...
                            if (file_exists(__DIR__ . "/uploads/photos/" . $filename)) {
            ...
            <div class="other-info-grid">
                <div class="form-group">
                    ...
                    <div class="radio-group mt-3">
                        <label><input type="radio" name="first_in_family" value="yes" <?php echo checkBool($student['first_in_family']); ?> disabled> Yes</label>
                        <label><input type="radio" name="first_in_family" value="no" <?php echo ($student['first_in_family'] == 0) ? 'checked' : ''; ?> disabled> No</label>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="checkbox-group mt-3">
                        ...
                        <label><input type="checkbox" <?php echo check('Orthopedic Disability', $disability); ?> disabled> Orthopedic Disability</label>
                        ...
                        <label><input type="checkbox" <?php echo empty($disability) ? 'checked' : ''; ?> disabled> None</label>
                    </div>
                    <div class="form-group mt-3">
                ...
                <div class="form-group">
                    ...
                    <div class="radio-group mt-3">
                        <label><input type="radio" name="coastal" value="yes" <?php echo checkBool($student['coastal_area']); ?> disabled> Yes</label>
                        <label><input type="radio" name="coastal" value="no" <?php echo ($student['coastal_area'] == 0) ? 'checked' : ''; ?> disabled> No</label>
                    </div>
                </div>
            </div>
    ...
    <div class="page">
            ...
            <div class="signature-box">
                ...
                <div class="sig-line">
                    <?php if (!empty($student['parent_guardian_signature']) && file_exists($student['parent_guardian_signature'])): ?>
                        <img src="uploads/signatures/<?php echo basename(e($student['parent_guardian_signature'])); ?>" alt="Parent Signature" style="max-height: 55px; max-width: 200px;">
                    <?php endif; ?>
                </div>
            ...
            <div class="signature-box">
                <div class="sig-line" style="margin-top: 19px;">
                    <?php if (!empty($student['student_signature']) && file_exists($student['student_signature'])): ?>
                        <img src="uploads/signatures/<?php echo basename(e($student['student_signature'])); ?>" alt="Student Signature" style="max-height: 55px; max-width: 200px;">
                    <?php endif; ?>
                </div>
        ...
        <p class="text-center text-bold" style="margin-top: 50px;">
            NOTE TO ADMISSIONS OFFICER: PLEASE ENSURE ALL ITEMS HAVE ENTRIES.
        </p>
